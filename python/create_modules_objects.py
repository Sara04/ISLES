...
from modules.meta_data_extraction import MetaDataExtractorISLES
...
required_modules =\
    {
        'database':
        {
            'mother_class': DatabaseISLES,
            'child_classes': None
        },
        'preprocessor':
        {
            'mother_class': PreprocessorISLES,
            'child_classes': modules.preprocessors
        },
        'augmentator':
        {
            'mother_class': AugmentatorISLES,
            'child_classes': None
        },
        'meta_data_extractor':
        {
            'mother_class': MetaDataExtractorISLES,
            'child_classes': None
        },
        'patch_extractor':
        {
            'mother_class': PatchExtractorISLES,
            'child_classes': modules.patch_extractors
        },
        'segmentator':
        {
            'mother_class': SegmentatorISLES,
            'child_classes': modules.segmentators
        },
        'postprocessor':
        {
            'mother_class': PostprocessorISLES,
...
def _config_file_error():
    ...
    print 'with classes\' names and corresponding arguments.'
    sys.exit(2)
...
def _invalid_module_name(m):
    print 'Module\'s name <<%s>> is invalid.' % m
    sys.exit(2)
